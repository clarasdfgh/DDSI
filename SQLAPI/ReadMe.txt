****************************************************************
               Welcome to SQLAPI++ Library 5.1.2
****************************************************************
...
Version 5.1.2
-- ODBC: Fixed the parameter presision bug for some SAParam::setAsNull() calling variants (thanks Thomas Oswald).
-- CubeSQL: Added cubesql_affected_rows and cubesql_last_inserted_rowID API functions (thanks Christian Schmitz).
-- MySQL: Use 'utf8mb4' Unicode charcter set instead of 'utf8' (thanks Karoly Harmath).
